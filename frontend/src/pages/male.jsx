...
import fam14 from '../assets/men1.jpeg'
...
export default function Male() {
    ...
    const filteredProducts = products?.filter((product) => {
        const fam = product.productType === 'male'
        ...
        <div className='bg-primary'>
            <div className='w-full   h-[300px]  relative'>
                ...
                <div className='absolute inset-0 flex flex-col mt-52 items-center justify-center gap-1 text-white'>
                    <div className='md:text-5xl text-center  text-[25px] font-bold'>{filteredProducts ? filteredProducts.length : '10'}+ Unique Male habesha For You</div>
            ...
            <div className='flex w-full flex-col items-center mt-10 pb-20 justify-center'>
                <div className='mt-[100px] w-[80%] flex justify-between'>
                    <div className='md:text-4xl text-3xl font-semibold'>Male Habesha</div>
                    <div>
