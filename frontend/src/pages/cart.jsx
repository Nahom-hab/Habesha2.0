...
const CartPage = () => {
    ...
    return (
        <div className="bg-primary w-full flex pb-32 justify-center p-6">
            ...
            {emptyCart && (
                <div className='fixed top-20 z-50 right-2 bg-red-500 text-white p-3 rounded-lg shadow-lg'>
            ...
            <div className="w-full md:w-[80%]">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="w-full lg:w-1/3 bg-gray-100 p-8 rounded-lg shadow-lg  top-16">
                        <h2 className="text-3xl font-semibold text-gray-800 mb-4 text-center">Order Summary</h2>

                        <div className="text-lg text-gray-700">
                            <div className="flex justify-between mb-3">
                                <span>Subtotal</span>
                                <span className="font-semibold">ETB {(getTotalPrice() * .85).toFixed(2)}</span>
                            </div>
                            <div className="flex justify-between mb-3">
                                <span>Shipping</span>
                        ...
                        }} className="mt-6 w-full py-3  bg-gradient-to-r from-[#caae8d] to-[#A78C6E] text-white text-lg font-semibold rounded-lg hover:bg-blue-700 transition duration-300">
                            Proceed to Checkout
                        </button>
                    </div>
                </div>
