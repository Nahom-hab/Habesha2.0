...
export default function Home() {
    ...
    return (
        <div className='bg-primary'>
            ...
            <div className='absolute top-16  z-10  block md:hidden   left-[-80px] '><img className='w-[370px]' src={home1} alt="" /></div>
            <img className='absolute top-32  left-[-40px] block md:hidden' src={shadow} alt="" />
            <div className='flex flex-col top-32  z-20 w-[200px]  absolute right-3 md:hidden'>
                <div className='font-bold flex text-white flex-col text-[34px] leading-tight'><span className='whitespace-nowrap text-[40px]'>Explore </span> <span>the World</span> <span >Of Habesha</span> </div>
                <div className=' font-semibold mt-4 hidden text-white md:flex text-[10px] flex-col'><span className=''>From the vibrant hues of our traditional fabrics to the </span><span>intricate patterns that adorn each piece</span></div>
                ...
                <div className='flex justify-end pr-5'>
                    <div onClick={() => navigate('/shop')} className='mt-6 px-4 py-1 text-black animate-bounce text-sm w-fit rounded-lg bg-[#f3f3f3]'>Shop Now</div>
                </div>

            </div>

            <div className='w-full flex justify-between items-center pl-20 h-[420px] md:h-[590px] bg-[#A78C6E]'>
                <div className='md:block hidden'>
                    <div className='font-bold flex flex-col text-white   md:text-[60px] leading-tight'><span className='whitespace-nowrap'>Explore the World</span> <span >Of <span className=''>Habesha</span></span> </div>
                    <div className='flex text-gray-200 font-semibold mt-7 flex-col'>From the vibrant hues of our traditional fabrics to the <span>intricate patterns that adorn each piece</span></div>
                    <button onClick={() => navigate('/shop')} className='mt-6 px-4 py-1 text-black text-lg animate-bounce rounded-lg bg-[#f3f3f3]'>Shop Now</button>
            ...
            <div>
                ...
                <div className='flex w-full  md:flex-row px-2 flex-col gap-1'>
                    <div className='flex md:h-[420px] w-full md:w-[50%] h-[300px] gap-1'>
                        <div onClick={() => navigate('/female')} className='flex flex-col  w-[50%] '>
                            <img className='h-full rounded-xl w-full object-cover' src={photo1} alt="" />
                            <div className='font-bold text-lg ml-2'>Female Habesha</div>
                            <div className='ml-2'>Starting from <span className='font-bold'>9000birr</span> </div>

                        </div>
                        <div onClick={() => navigate('/couples')} className='flex flex-col  w-[50%] '>
                            <img className='h-full rounded-xl w-full object-cover' src={photo3} alt="" />
                    ...
                    <div className='flex md:h-[420px] mt-6 w-full md:w-[50%]  md:mt-0 h-[300px] gap-1'>

                        <div onClick={() => navigate('/male')} className='flex flex-col w-[50%] '>
                            <img className='h-full rounded-xl w-full object-cover' src={photo2} alt="" />

                            <div className='font-bold ml-2 text-lg'>Male Habesha</div>
                            <div className='ml-2'>Starting from <span className='font-bold'>8000birr</span> </div>


                        </div>
                        <div onClick={() => navigate('/couples')} className='flex flex-col w-[50%] '>
                            <img className='h-full rounded-xl w-full object-cover' src={photo4} alt="" />

                            <div className='font-bold ml-2 text-lg'>Couple Habesha</div>
                            <div className='ml-2'>Starting from <span className='font-bold'>23000birr</span> </div>
            ...
            <div className='mt-5 md:px-24 mb-8 w-full pt-5 px-3'>
                <div className='mb-4 text-3xl font-bold'>Exclusive Collection Of Habesha's</div>
                {/* Product Grid */}
                {products ?
            ...
            <div className='mt-2 flex md:flex-row mb-[300px] flex-col md:mb-2 justify-between'>
                <div className='md:w-[77%] w-full   h-[300px]  relative'>
                    ...
                    <div className='absolute inset-0 flex flex-col mt-52 items-center justify-center gap-1 text-white'>
                        <div className='md:text-5xl text-center whitespace-nowrap text-[20px] font-bold'>70+ Unique Designs For You</div>
