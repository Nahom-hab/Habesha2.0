...
export default function ContactUs() {
    ...
    return (
        <div className='bg-primary  dark:bg-gray-800 dark:border-gray-600 mt-[8px] pb-32'>
            {/* Modal for successful message */}
            {isModalOpen && (
                <div className="fixed  inset-0 flex items-center justify-center bg-primary px-2 bg-opacity-30 z-50 animate-fadeIn">
                    <div className=" dark:bg-gray-900 p-8 bg-primary rounded-lg  text-center transform shadow-xl scale-95 transition-transform duration-300">
                        ...
                        <button
                            onClick={closeModal}
                            className="bg-gradient-to-r from-[#caae8d] to-[#A78C6E] text-white px-4 py-2 rounded  transition duration-300"
                        >
                            Close
                        </button>
                    </div>
                        ...
                        <form className="text-black dark:text-white space-y-3" onSubmit={handleSubmit}>
                            <div className="flex flex-col">
                                ...
                                <input
                                    ...
                                    className="p-3 bg-gray-200 dark:bg-gray-700 placeholder-gray-400 dark:placeholder-gray-300 rounded-xl focus:outline-none"
                            ...
                            <button
                                type="submit"
                                className={`w-full ${isLoading ? 'bg-gray-500' : 'bg-gradient-to-r from-[#caae8d] to-[#A78C6E]'} text-white py-3 rounded-xl hover:bg-blue-600 transition duration-300`}
                                disabled={isLoading}
                            >
