        ...
        <div className='bg-primary'>
            <div className='w-full   h-[300px]  relative'>
                ...
                <div className='absolute inset-0 flex flex-col mt-52 items-center justify-center gap-1 text-white'>
                    <div className='md:text-5xl text-center  text-[25px] font-bold'>{filteredProducts ? filteredProducts.length : '10'}+ Unique Female Habesha For You</div>
                        ...
                        <div className='relative'>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className='w-full bg-gradient-to-r from-[#caae8d] to-[#A78C6E] bg-blue-600 text-white py-2 rounded-md transition-transform transform hover:scale-105'
                                >
                                    Apply Filters
                                </button>
                            </div>
