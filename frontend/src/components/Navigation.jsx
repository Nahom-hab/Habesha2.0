...
export default function Navigation() {
    ...
    return (
        <div className='fixed top-0 left-0 z-50 w-full'>
            {/* Main navigation bar */}
            <div className='flex bg-primary shadow-lg py-5 justify-between px-5 pl-2'>
                <Link to={'/'} onClick={closeSidebar} className={`px-3 rounded `}>
                    <span className='text-2xl font-bold text-[#A78C6E]'>ፍካት ሃበሻ </span>
                </Link>
                ...
                <div className='flex items-center gap-5'>
                    <Link to={'/cart'} className='text-3xl flex gap-2 items-center'>
                        <div className='relative'>
                            <FaCartPlus className='text-[#A78C6E]' />
            ...
            {isSidebarOpen && <div className="fixed inset-0 bg-[#A78C6E] opacity-50" onClick={closeSidebar}></div>}
        </div>
    );
}
